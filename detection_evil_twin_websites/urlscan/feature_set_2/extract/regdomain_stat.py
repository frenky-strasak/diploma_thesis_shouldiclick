...
class Regdomain_stat:
    ...
    def __init__(self, urlscan_dict: Dict):
        ...
        self.absolute_dict['len'] = len(self.regDomainStats)

    def compute_features(self):
        if self.data_available:
            for stat in self.regDomainStats:
                ...
                for numerical_feature in self.numerical_features_names:
                    if numerical_feature == 'ips' or numerical_feature == 'initiators' or numerical_feature == 'subDomains':
                        try:
